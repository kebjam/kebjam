...
def main():
    ...
    with tab3:
        st.markdown("""
                ...
                - Une interface Streamlit conviviale, permettant un accès simple et rapide aux fonctionnalités depuis n'importe quel navigateur web.
                ...
                ###### Elèves analystes statisticiens en 3 ème année 
                
                ##### Sous la soupervision de : 
                ##### Mme. Mously DIAW, Senior ML Engineer
                """)    
